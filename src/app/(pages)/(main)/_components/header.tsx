...
//   return (
//     <header className="relative h-16 w-full flex items-center justify-between bg-gray-50 border-b border-gray-200 px-6 shadow-sm z-50">
//       {/* Logo */}
//       <Link href="/" className="flex items-center gap-3 hover:opacity-80">
//         <img
//           src={logoUrl}
...
//       {/* Right section */}
//       <div className="flex items-center gap-4">
//         <div className="flex items-center bg-white border border-gray-300 rounded px-3 h-10 w-56">
//           <Search className="w-5 h-5 text-gray-500 mr-2" />
//           <Input
//             type="text"
//             placeholder="Tìm kiếm..."
...
//           <PopoverTrigger
//             onMouseEnter={() => {
//               if (!isUserMenuLocked) setIsUserMenuOpen(true);
//             }}
//             onMouseLeave={() => {
//               if (!isUserMenuLocked) setIsUserMenuOpen(false);
//             }}
//             onClick={(e) => {
//               e.preventDefault();
//               if (isUserMenuLocked) {
...
//               }
//             }}
//             className="flex items-center gap-3 bg-gray-100 rounded-tr-2xl rounded-br-2xl px-5 py-2 min-w-52 border-l border-gray-200 cursor-pointer"
//           >
//             <div className="h-10 w-10 rounded-full flex items-center justify-center overflow-hidden">
//               {avatarUrl ? (
//                 <img
...
//         <div className="absolute top-16 left-0 w-full bg-white border-t border-gray-200 shadow z-40 md:hidden">
//           <ul className="flex flex-col text-sm p-4 gap-3">
//             {menus.map((menu) => (
//               <div key={menu.title}>
//                 <span className="font-semibold text-gray-800 block mb-1">{menu.title}</span>
//                 {menu.items.map((item) => (
//                   <li key={item.href}>
//                     <Link
//                       href={item.href}
